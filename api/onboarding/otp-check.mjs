...
import {checkTelegramCode} from '../_lib/verification.mjs';
...
export default async function handler(req,res){
  ...
  try{
    ...
    if(challenge.channel!=='telegram')throw Object.assign(new Error('Unsupported channel'),{status:400,publicMessage:'Request a new Telegram verification code'});
    const valid=await checkTelegramCode(challenge.provider_request_id,code);
