...
export default async function handler(req,res){
  ...
  try{
    ...
    if(!member||member.status!=='active'||member.verification!=='verified')throw Object.assign(new Error('Membership unavailable'),{status:403,publicMessage:'Member is not currently active and approved'});
