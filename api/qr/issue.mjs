...
export default async function handler(req,res){
  ...
  try{
    ...
    if(actor.profile.status!=='active'||actor.profile.verification!=='verified')throw Object.assign(new Error('Inactive member'),{status:403,publicMessage:'Your membership must be approved and active'});
